      ...
      <main className="pt-24 px-6 max-w-md mx-auto flex-grow w-full pb-32">
        ...
        <section className="flex flex-col items-center mb-12 text-center">
          <div className="relative mb-6">
            <div className="w-24 h-24 rounded-full p-[1px] bg-gradient-to-b from-primary to-transparent">
              <img
                alt="User Profile"
                className="w-full h-full object-cover rounded-full grayscale hover:grayscale-0 transition-all duration-500"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDWxlXa4c2VrGL9m7ZHrDmWX_Xb7L9PhwGb1ca_5kHqmEioUCewf5PUpHjE74PBfGUNO9alTuzQkys7b7-BwMsqzX8NXYGkNviZ-MB6yX0XpO81nMXs8GVycOiCAh08VoMyP-DXagzueFlYraG9YoiKD1cKJZ-1n_u7s5tIhMAjFwSnQ4CSkoYzNFF3l-j6nA0t4V-QQGyw_krO40eq7O8U7rEfGMzS1S-7xS-XVwv58NPLzDqkALc1LYGF0oIX_iOVs1UF1E5TYsxI"
              />
            </div>
            <div className="absolute bottom-0 right-0 bg-primary text-on-primary p-1.5 rounded-full flex items-center justify-center shadow-lg cursor-pointer">
              <span className="material-symbols-outlined text-sm fill-1">edit</span>
            </div>
          </div>
          <h2 className="font-headline text-3xl italic text-on-surface mb-1">Julian Vance</h2>
        ...
        <section className="pt-4 border-t border-outline-variant/10">
          <button className="w-full flex items-center justify-center gap-3 py-4 text-error font-label text-[11px] uppercase tracking-[0.2em] font-bold hover:bg-error/5 transition-colors">
